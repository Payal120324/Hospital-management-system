...
public class Doctor
{
    static final String DB_URL = "user name";
...
//add new doctor information
    ...
    public  Doctor new_doctor()
    {
        ...
        return new Doctor(did, docname, dspecialist, dappoint, ddoc_qual,dnum);
...
public void getinfoall() {
    try (Connection con = DriverManager.getConnection(DB_URL, USER, PASS);
        ...
        while (rs.next()) {
            ...
            String specialist = rs.getString("dspecialist");
            String workHours = rs.getString("dappoint");
            String qualifications = rs.getString("ddoc_qual");
            String emergencyNumber = rs.getString("ddroom");

            System.out.printf("%s\t|\t%s\t|\t%s\t|\t%s\t|\t%s\t|\t%s\n", id, name, specialist, workHours, qualifications, emergencyNumber);
            System.out.println("---------------------------------------------------------------------------------------------------------------------------------");
        }
    } catch (SQLException e) {
        e.printStackTrace();
...
public void updatedoc(){
        ...
        String id= input.nextLine();
        this.setId(id);
         System.out.println("what do you want to udate (Id,name,speciality,appointments,qualifications)?");
...
//open database
          try(Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);){
                   System.out.print("deletion started");
